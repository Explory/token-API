...
export default class NftController {
    ...
    public getMatadataById = async (req: Request, res: Response): Promise<any> => {
        try {
            ...
            const { data } = await axios.get(`${apiUrl}/GetNftDetailsById/${apiKey}/${id}/${nftid}`);
    ...
    public uploadNft = async (req: Request, res: Response): Promise<any> => {
        try {
            ...
            const { id } = req.params;
            const { data } = await axios.post(`${apiUrl}/UploadNft/${apiKey}/${id}/`, req.body);
    ...
    public buyNft = async (req: Request, res: Response): Promise<any> => {
        try {
            ...
            const { id } = req.params;
            const { data } = await axios.post(`${apiUrl}/GetAddressForSpecificNftSale/${apiKey}/${id}`, req.body);
